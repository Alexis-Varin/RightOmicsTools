...
You first need to make sure you have Rtools installed, as some dependencies required for `RightOmicsTools` are not available on CRAN and require compilation. You may download Rtools from [here](https://cran.r-project.org/bin/windows/Rtools/).
